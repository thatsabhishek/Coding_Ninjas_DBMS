Problem Statement:
List down the product names along with the details like the time the payment for the order was made and delivery date along with the transaction status of that product by the customer and sort it according to their respective payment date.
...
Output:
+------------------------------------------------------+--------------+-------------------+--------------------+
| p_name                                               | payment_date | est_delivery_date | transaction_status |
+------------------------------------------------------+--------------+-------------------+--------------------+
| Ikigai: The Japanese secret to a long and happy life | 2021-11-06   | 2021-11-09        | completed          |
| Iphone 11 (128GB)                                    | 2021-11-09   | 2021-11-13        | not completed      |
| Iphone 11 (128GB)                                    | 2021-11-10   | 2021-11-14        | completed          |
| OnePlus 9 Pro 5G (256GB)                             | 2021-11-12   | 2021-11-14        | completed          |
| Inalsa Electric Kettle Absa (Black/Silver)           | 2021-11-24   | 2021-12-03        | not completed      |
| optimum whey protien                                 | 2021-11-27   | 2021-12-04        | not completed      |
+------------------------------------------------------+--------------+-------------------+--------------------+