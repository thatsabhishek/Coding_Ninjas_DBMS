Problem Statement:
Write an SQL query to print all the details of the products whose seller’s name ends with ‘n’ and contains only seven alphabets.
...
|       4 |       6754 | Inalsa Electric Kettle Absa (Black/Silver)                              | Y       |      591 |            9 | 
k3stores                  |   10040 |
