Problem Statement:
List all the distinct products which are ordered with their customer id and customer name.
...
Output:
+------------------------------------------------------+-------------+-----------------+
| p_name                                               | customer_id | customer_name   |
+------------------------------------------------------+-------------+-----------------+
| Iphone 11 (128GB)                                    | cid3        | Vishwas Aanand  |
| Iphone 11 (128GB)                                    | cid1        | Riya Khanna     |
| optimum whey protien                                 | cid7        | Kuldeep Daga    |
| Inalsa Electric Kettle Absa (Black/Silver)           | cid5        | Priyanshu Gupta |
| OnePlus 9 Pro 5G (256GB)                             | cid3        | Vishwas Aanand  |
| Ikigai: The Japanese secret to a long and happy life | cid2        | Sahil Kumar     |
+------------------------------------------------------+-------------+-----------------+