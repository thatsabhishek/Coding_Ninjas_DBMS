Problem Statement:
List all the product names with their respective payment date and delivery date and sort the output table w.r.t to delivery date.
...
Output:
+------------------------------------------------------+--------------+-------------------+
| p_name                                               | payment_date | est_delivery_date |
+------------------------------------------------------+--------------+-------------------+
| Ikigai: The Japanese secret to a long and happy life | 2021-11-06   | 2021-11-09        |
| Iphone 11 (128GB)                                    | 2021-11-09   | 2021-11-13        |
| Iphone 11 (128GB)                                    | 2021-11-10   | 2021-11-14        |
| OnePlus 9 Pro 5G (256GB)                             | 2021-11-12   | 2021-11-14        |
| Inalsa Electric Kettle Absa (Black/Silver)           | 2021-11-24   | 2021-12-03        |
| optimum whey protien                                 | 2021-11-27   | 2021-12-04        |
+------------------------------------------------------+--------------+-------------------+