Problem Statement:
Find the duplicate product id and seller name along with count of duplicate entries from the tables given below considering there is no primary key (item_id).
...
Output:
+------------+----------------------+----------+
| product_id | seller               | count(*) |
+------------+----------------------+----------+
|       7556 | Maple Store          |        2 |
|       2223 | Cloudtail India      |        2 |
|       6754 | k3stores             |        2 |
|       7777 | Darshita Etel        |        3 |
|       5655 | Darshita Electronics |        2 |
+------------+----------------------+----------+
